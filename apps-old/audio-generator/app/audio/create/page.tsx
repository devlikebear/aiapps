...
import {
  ...
  wavToBlob,
  downloadAudio,
} from '@/lib/utils/audio-converter';
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setPrompt({
                  ...prompt,
                  genre: value ? (value as typeof prompt.genre) : undefined,
                });
              }}
            >
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setPrompt({
                  ...prompt,
                  mood: value ? (value as typeof prompt.mood) : undefined,
                });
              }}
            >
              <option value="">선택 안함</option>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              value={prompt.bpm}
              onChange={(e) =>
                setPrompt({ ...prompt, bpm: parseInt(e.target.value) })
              }
              className="w-full"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) =>
                setPrompt({ ...prompt, density: parseFloat(e.target.value) })
              }
              className="w-full"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) =>
                setPrompt({ ...prompt, brightness: parseFloat(e.target.value) })
              }
              className="w-full"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={(e) =>
                setPrompt({ ...prompt, duration: parseInt(e.target.value) })
              }
              className="w-full p-2 border rounded-lg"
            />
          </div>
        ...
        {generatedAudio && status === 'completed' && (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600">
                BPM: {generatedAudio.metadata.bpm} | Key:{' '}
                {generatedAudio.metadata.key} | Scale:{' '}
                {generatedAudio.metadata.scale} | Duration:{' '}
                {generatedAudio.metadata.duration}s
              </p>
            </div>
