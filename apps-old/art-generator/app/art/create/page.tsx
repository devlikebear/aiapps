          ...
          <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setPrompt({ ...prompt, negativePrompt: e.target.value })
                }
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setPrompt({
                    ...prompt,
                    style: value ? (value as typeof prompt.style) : undefined,
                  });
                }}
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setPrompt({
                    ...prompt,
                    artType: value
                      ? (value as typeof prompt.artType)
                      : undefined,
                  });
                }}
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  value={prompt.width}
                  onChange={(e) =>
                    setPrompt({ ...prompt, width: parseInt(e.target.value) })
                  }
                  min={256}
                  max={2048}
                  step={64}
              ...
              <div>
                ...
                <input
                  ...
                  value={prompt.height}
                  onChange={(e) =>
                    setPrompt({ ...prompt, height: parseInt(e.target.value) })
                  }
                  min={256}
                  max={2048}
                  step={64}
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setPrompt({
                    ...prompt,
                    format: e.target.value as typeof prompt.format,
                  })
                }
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              >
