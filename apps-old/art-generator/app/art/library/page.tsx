...
export default function LibraryPage() {
  const { filteredLibrary, loadLibrary, deleteFromLibrary, filterLibrary } =
    useImageStore();
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setFilters({
                    ...filters,
                    style: value ? (value as typeof filters.style) : undefined,
                  });
                }}
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setFilters({
                    ...filters,
                    artType: value
                      ? (value as typeof filters.artType)
                      : undefined,
                  });
                }}
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setFilters({
                    ...filters,
                    mood: value ? (value as typeof filters.mood) : undefined,
                  });
                }}
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              >
