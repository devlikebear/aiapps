...
interface ImageState {
  // Status
  status: 'idle' | 'generating' | 'editing' | 'composing' | 'transferring' | 'error';
  error: string | null;
...
export const useImageStore = create<ImageState>((set, get) => ({
  ...
  generateImage: async (prompt) => {
    set({ status: 'generating', error: null, generatedImage: null, tokenCost: null });
  ...
  editImage: async (edit) => {
    set({ status: 'editing', error: null, generatedImage: null, tokenCost: null });
  ...
  composeImages: async (compose) => {
    set({ status: 'composing', error: null, generatedImage: null, tokenCost: null });
  ...
  transferStyle: async (transfer) => {
    set({ status: 'transferring', error: null, generatedImage: null, tokenCost: null });
